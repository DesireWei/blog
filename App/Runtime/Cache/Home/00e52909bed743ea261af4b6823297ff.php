...
<link href="/myblog/Public/css/animate.min.css" rel="stylesheet"> 
<link href="/myblog/Public/css/prettyPhoto.css" rel="stylesheet">
<link href="/myblog/Public/css/styles.css" rel="stylesheet"> 
<!--[if lt IE 9]>
<script src="js/html5shiv.js"></script>
<script src="js/respond.min.js"></script>
<![endif]-->       
<link rel="shortcut icon" href="/myblog/Public/images/ico/favicon.ico"> 
</head> 
	...
	<nav id="main-nav" class="navbar navbar-default navbar-fixed-top" role="banner">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="/myblog"><img src="/myblog/Public/images/logo.png" alt="logo"></a>
			</div>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-6 wow fadeInLeft">
			  <img class="img-responsive" src="/myblog/Public/images/about.png" alt="">
			</div>
		...
		<div class="row text-center">
			<div class="col-md-3 col-sm-6 col-xs-12">
				<div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="0ms">
					<div class="team-img">
						<img class="img-responsive" src="/myblog/Public/images/team/01.jpg" alt="">
					</div>
					<div class="team-info">
						<h3>Micky Deo</h3>
						<span>Founder</span> 
			...
			<div class="col-md-3 col-sm-6 col-xs-12">
				<div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="100ms">
					<div class="team-img">
						<img class="img-responsive" src="/myblog/Public/images/team/02.jpg" alt="">
					</div>
					<div class="team-info">
						<h3>Mike Timobbs</h3>
			...
			<div class="col-md-3 col-sm-6 col-xs-12">
				<div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="200ms">
					<div class="team-img">
						<img class="img-responsive" src="/myblog/Public/images/team/03.jpg" alt="">
					</div>
					<div class="team-info">
						<h3>Remo Silvaus</h3>
			...
			<div class="col-md-3 col-sm-6 col-xs-12">
				<div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="300ms">
					<div class="team-img">
						<img class="img-responsive" src="/myblog/Public/images/team/04.jpg" alt="">
					</div>
					<div class="team-info">
						<h3>Niscal Deon</h3>
						<span>Massager</span> 
		...
		<div class="portfolio-items">
			<div class="portfolio-item designing">
				<div class="portfolio-item-inner">
					<img class="img-responsive" src="/myblog/Public/images/portfolio/01.jpg" alt="">
					<div class="portfolio-info"> 
						<a class="preview" href="/myblog/Public/images/portfolio/01.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
					</div>
				</div>
			</div><!--/.portfolio-item-->
			...
			<div class="portfolio-item mobile development">
				<div class="portfolio-item-inner">
					<img class="img-responsive" src="/myblog/Public/images/portfolio/02.jpg" alt="">
					<div class="portfolio-info"> 
						<a class="preview" href="/myblog/Public/images/portfolio/02.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
					</div>
				</div>
			</div><!--/.portfolio-item-->
			...
			<div class="portfolio-item designing">
				<div class="portfolio-item-inner">
					<img class="img-responsive" src="/myblog/Public/images/portfolio/03.jpg" alt="">
					<div class="portfolio-info"> 
						<a class="preview" href="/myblog/Public/images/portfolio/03.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
					</div>
				</div>
			</div><!--/.portfolio-item-->
			...
			<div class="portfolio-item mobile">
				<div class="portfolio-item-inner">
					<img class="img-responsive" src="/myblog/Public/images/portfolio/04.jpg" alt="">
					<div class="portfolio-info"> 
						<a class="preview" href="/myblog/Public/images/portfolio/04.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
					</div>
				</div>
			</div><!--/.portfolio-item-->
			...
			<div class="portfolio-item designing development">
				<div class="portfolio-item-inner">
					<img class="img-responsive" src="/myblog/Public/images/portfolio/05.jpg" alt="">
					<div class="portfolio-info"> 
						<a class="preview" href="/myblog/Public/images/portfolio/05.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
					</div>
				</div>
			</div><!--/.portfolio-item-->
			...
			<div class="portfolio-item mobile">
				<div class="portfolio-item-inner">
					<img class="img-responsive" src="/myblog/Public/images/portfolio/06.jpg" alt="">
					<div class="portfolio-info"> 
						<a class="preview" href="/myblog/Public/images/portfolio/06.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
					</div>
				</div>
			</div><!--/.portfolio-item-->
			...
			<div class="portfolio-item designing development">
				<div class="portfolio-item-inner">
					<img class="img-responsive" src="/myblog/Public/images/portfolio/07.jpg" alt="">
					<div class="portfolio-info"> 
						<a class="preview" href="/myblog/Public/images/portfolio/07.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
					</div>
				</div>
			</div><!--/.portfolio-item-->
			...
			<div class="portfolio-item mobile">
				<div class="portfolio-item-inner">
					<img class="img-responsive" src="/myblog/Public/images/portfolio/08.jpg" alt="">
					<div class="portfolio-info"> 
						<a class="preview" href="/myblog/Public/images/portfolio/08.jpg" rel="prettyPhoto"><i class="fa fa-eye"></i></a>
					</div>
				</div>
			</div><!--/.portfolio-item-->
		</div>
			...
			<div class="row">
				<div class="col-md-4">
					<div class="single-testimonial animate_fade_in" style="opacity: 1; right: 0px;">
						...
						<div class="row">
							<div class="col-xs-3">
								<img src="/myblog/Public/images/pic1.jpg" alt="client">
							</div>
				...
				<div class="col-md-4">
					<div class="single-testimonial animate_fade_in" style="opacity: 1; right: 0px;">
						...
						<div class="row">
							<div class="col-xs-3">
								<img src="/myblog/Public/images/pic2.jpg" alt="client">
							</div>
							<div class="col-xs-9 half-gutter">
								<h5>John Bond</h5>
								<h6>Lorem Ipsuis simply</h6>
...
<script src="/myblog/Public/js/mousescroll.js"></script>
<script src="/myblog/Public/js/smoothscroll.js"></script>
<script src="/myblog/Public/js/jquery.prettyPhoto.js"></script>
<script src="/myblog/Public/js/jquery.isotope.min.js"></script>
<script src="/myblog/Public/js/jquery.inview.min.js"></script>
<script src="/myblog/Public/js/wow.min.js"></script>
<script src="/myblog/Public/js/custom-scripts.js"></script>
</body>
</html>